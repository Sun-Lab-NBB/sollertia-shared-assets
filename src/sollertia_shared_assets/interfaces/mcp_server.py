...
def _unity_relay(tool: str, args: dict[str, Any] | None = None) -> dict[str, Any]:
    """Relays a tool call to the Unity Editor's McpBridge HTTP listener.

    Args:
        tool: The tool name to invoke on the Unity side.
        args: The tool arguments dictionary. Defaults to an empty dict when omitted.
    ...
    try:
        ...
        return _err(message="Unity bridge returned invalid JSON.")


# --------------------------------------------------------------------------------------------------
#  Unity Editor relay tools
# --------------------------------------------------------------------------------------------------
...
def generate_task_prefab_tool(template_name: str, save_path: str | None = None) -> dict[str, Any]:
    ...
    """
    args: dict[str, Any] = {"template_name": template_name}
    if save_path is not None:
        args["save_path"] = save_path
    return _unity_relay(tool="generate_task_prefab", args=args)
...
def inspect_prefab_tool(prefab_path: str) -> dict[str, Any]:
    ...
    """
    return _unity_relay(tool="inspect_prefab", args={"prefab_path": prefab_path})
...
def validate_prefab_against_template_tool(template_name: str) -> dict[str, Any]:
    ...
    """
    return _unity_relay(tool="validate_prefab_against_template", args={"template_name": template_name})


@mcp.tool()
def list_unity_assets_tool(asset_type: str = "Prefab", search_path: str = "Assets/InfiniteCorridorTask") -> (
    dict[str, Any]
):
    ...
    """
    return _unity_relay(tool="list_unity_assets", args={"type": asset_type, "path": search_path})
...
def open_scene_tool(scene_path: str) -> dict[str, Any]:
    ...
    """
    return _unity_relay(tool="open_scene", args={"scene_path": scene_path})
...
def create_scene_tool(scene_name: str, task_prefab_path: str | None = None) -> dict[str, Any]:
    ...
    Returns:
        A response dict with ``scene_path`` and ``message``.
    """
    args: dict[str, Any] = {"scene_name": scene_name}
    if task_prefab_path is not None:
        args["task_prefab_path"] = task_prefab_path
    return _unity_relay(tool="create_scene", args=args)
