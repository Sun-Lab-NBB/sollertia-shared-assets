...
type ExperimentConfigFactory = Callable[
    [str, dict[str, WaterRewardTrial | GasPuffTrial]], MesoscopeExperimentConfiguration
]
...
def _create_mesoscope_experiment_config(
    unity_scene_name: str, trial_structures: dict[str, WaterRewardTrial | GasPuffTrial]
) -> MesoscopeExperimentConfiguration: ...
